...
import logoImg from "../imgs/meteor_logo.svg";
    ...
    <footer className="footer-wrapper">
      <div className="Index-page-content">
        <div className="newsletter-wrapper">
          ...
          <p>
            Sign up to receive a monthly email on the latest Meteor updates,
            features and news!
          </p>
          <a href="/">
            <p>Sign Up Now</p>
        ...
        <div className="copyright-wrapper">
          ...
          <div className="social-links">
            ...
            <div className="social-link Medium">
              <a href="/">
                <svg
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
